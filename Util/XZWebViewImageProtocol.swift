...
fileprivate let XZWebViewImageProtocolHandledKey = "XZWebViewImageProtocolHandledKey"

class XZWebViewImageProtocol: URLProtocol ,URLSessionDataDelegate {
    ...
    override class func canInit(with request: URLRequest) -> Bool{
        ...
        if ["jpg","jpeg","png","gif"].contains(pathExtension.lowercased()) {
            if let tag = self.property(forKey: XZWebViewImageProtocolHandledKey, in: request) as? Bool , tag == true {
                return false
            }
            return true
        }
    ...
    override func startLoading() {
        ...
        if let data = data {
            ...
            XZWebViewImageProtocol.setProperty(true, forKey: XZWebViewImageProtocolHandledKey, in: newRequest)
