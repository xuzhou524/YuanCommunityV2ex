...
#import "YuanCommunityV2ex.h"
@import GoogleMobileAds;

@interface YuanCommunityV2ex()<GADFullScreenContentDelegate>{
...
@implementation YuanCommunityV2ex
...
-(void)CheakAd{//这一部分的逻辑大家根据自身需求定制
    ...
    GADRequest *request = [GADRequest request];
      [GADInterstitialAd loadWithAdUnitID:@"ca-app-pub-9353975206269682/1164640455"
                                      request:request
