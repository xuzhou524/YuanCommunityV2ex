...
class V2Photo :NSObject{
    static let V2PHOTO_PROGRESS_NOTIFICATION = "ME.AARON_XU.V2PHOTO_PROGRESS_NOTIFICATION"
    static let V2PHOTO_LOADING_DID_END_NOTIFICATION = "ME.AARON_XU.V2PHOTO_LOADING_DID_END_NOTIFICATION"
